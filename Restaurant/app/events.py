...
class ReconnectingEventConsumer(object):
    
    def __init__(self, amqp_url):
        self._reconnect_delay = 0
        self._amqp_url = amqp_url
        self._consumer = EventConsumer(self._amqp_url)
...
def connect():
    ...
    amqp_url = 'amqp://event-bus:5672/%2F'
    consumer = ReconnectingEventConsumer(amqp_url)
    consumer.run()
